...
#rerun ping using repeatmasker file generated by mping/ping/pong
python ReNameSRA_RelocaTEi_ReRunOnResults.py --input Japonica_fastq_RelocaTEi > log 2>&1 &
python ReNameSRA_RelocaTEi_ReRunOnResults.py --input Other_fastq_RelocaTEi > log 2>&1 &
