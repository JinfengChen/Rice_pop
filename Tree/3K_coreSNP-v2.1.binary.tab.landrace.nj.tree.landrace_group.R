...
pdf("3K_coreSNP-v2.1.binary.tab.landrace.nj.tree.landrace_group.pdf", width=7, height=9)
...
plot(tree, edge.color=edge_colors, show.tip.label = TRUE, cex = 0.3, underscore=TRUE)
