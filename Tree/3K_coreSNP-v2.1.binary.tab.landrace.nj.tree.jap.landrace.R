...
library("ape")
tree = read.tree(file="3K_coreSNP-v2.1.binary.tab.landrace.nj.tree.jap.landrace.tree")
tree$edge.length[tree$edge.length<0]<-0
x = read.table(file="3K_coreSNP-v2.1.binary.tab.landrace.nj.tree.jap.landrace.anno", sep='\t', header=1)
y = setNames(x[,7], x[,1])
...
pdf("3K_coreSNP-v2.1.binary.tab.landrace.nj.tree.jap.landrace.pdf", width=7, height=9)
