...
library("ape")
tree = read.tree(file="3K_coreSNP-v2.1.binary.tab.landrace.nj.tree.jap.nolandrace.tree")
x = read.table(file="3K_coreSNP-v2.1.binary.tab.landrace.nj.tree.jap.nolandrace.anno", sep='\t', header=1)
y = setNames(x[,7], x[,1])
...
pdf("3K_coreSNP-v2.1.binary.tab.landrace.nj.tree.jap.nolandrace.pdf")
