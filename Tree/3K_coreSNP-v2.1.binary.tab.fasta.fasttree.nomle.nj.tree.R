...
library("ape")
tree = read.tree(file="3K_coreSNP-v2.1.binary.tab.fasta.fasttree.nomle.nj.tree")
x = read.table(file="rice_line_ALL_3000.anno.list", sep='\t', header=1)
y = setNames(x[,7], x[,1])
...
pdf("3K_coreSNP-v2.1.binary.tab.fasta.fasttree.nomle.nj.tree.pdf")
