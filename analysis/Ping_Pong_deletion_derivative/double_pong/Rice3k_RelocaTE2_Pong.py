...
def main():
    ...
    if not args.genome:
        ...
        args.genome = '/rhome/cjinfeng/Rice/Rice_population_sequence/Rice_3000/analysis/Ping_Pong_deletion_derivative/double_pong/pong.fa'
    ...
    if not args.repeat:
        ...
        args.repeat = '/rhome/cjinfeng/Rice/Rice_population_sequence/Rice_3000/analysis/Ping_Pong_deletion_derivative/double_pong/pong.fa'
    ...
    if not os.path.exists(project):
        os.mkdir(project)
    print project
    read_dirs = glob.glob('%s/*_pong' %(os.path.abspath(args.input)))
