png("Zero_Pong.png", width=700, height=400)
library(reshape)
library(ggplot2)
library(Rmisc)
...
image(1:430, 1:18, mping_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
mtext("mPing", side=1, line=3, font=3, cex=1.2)
mtext("O. sativa", side=2, line=3, font=3, cex=1.2)
axis(2, at=c(1, 18), labels=c(1, 18), cex.lab=1.2)


#ping
ping <- t(ping)
ping_matrix <- as.matrix(ping)
image(1:5339, 1:18, ping_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
...
image(1:5164, 1:18, pong_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
...
image(1:5874, 1:18, control_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
