pdf("Zero_mPing.pdf", width=7, height=4)
par(mar=c(5,5,4,2))
library(reshape)
library(ggplot2)
library(Rmisc)
...
mping <- t(mping)
mping_matrix <- as.matrix(mping)
image(1:429, 1:220, mping_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
mtext("mPing", side=1, line=3, font=3, cex=1.2)
mtext("Rice strains", side=2, line=3, font=1, cex=1.2)
axis(2, at=c(1, 220), labels=c(1, 220), cex.lab=1.4, cex.axis=1.4)
...
image(1:5340, 1:220, ping_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
...
image(1:5165, 1:220, pong_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
...
image(1:5875, 1:220, control_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
