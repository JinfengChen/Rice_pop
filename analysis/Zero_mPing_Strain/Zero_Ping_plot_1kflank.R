png("Zero_Ping.png", width=700, height=400)
library(reshape)
library(ggplot2)
library(Rmisc)
...
ping <- read.table("ping_3k_NM0.txt")
...
image(1:5339, 1:2749, ping_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
mtext("Ping", side=1, line=3, font=3, cex=1.2)
#mtext("O. sativa", side=2, line=3, font=3, cex=1.2)
#axis(2, at=c(1, 100, 200, 220), labels=c(1, 100, 200, 220), cex.lab=1.2)

pong <- read.table("pong_3k_NM0.txt")
...
image(1:5164, 1:2749, pong_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
...
image(1:5874, 1:2749, control_matrix, axes=FALSE, xlab = "", ylab = "", col = c("palegoldenrod", "cadetblue3"))
