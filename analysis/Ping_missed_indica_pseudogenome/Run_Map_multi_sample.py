...
def runjob(script, lines):
    cmd = 'perl /rhome/cjinfeng/BigData/software/bin/qsub-slurm.pl --maxjob 60 --lines %s --interval 120 --task 1 --mem 15G --time 10:00:00 --queue batch --convert no %s' %(lines, script)
    #print cmd 
    os.system(cmd)
