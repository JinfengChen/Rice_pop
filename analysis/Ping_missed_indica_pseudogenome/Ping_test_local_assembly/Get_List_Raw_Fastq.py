...
def main():
    ...
    fq_sub_1 = '{}_1.fq'.format(re.sub(r'.list', r'', args.list))
    fq_sub_2 = '{}_2.fq'.format(re.sub(r'.list', r'', args.list))
    os.system('/rhome/cjinfeng/BigData/software/seqtk-master/seqtk subseq {} {} > {}'.format(args.fq1, args.list, fq_sub_1))
    os.system('/rhome/cjinfeng/BigData/software/seqtk-master/seqtk subseq {} {} > {}'.format(args.fq2, args.list, fq_sub_2))
