...
x = read.table(file="OtherTE_DNA_RelocaTE2.summary.list", sep='\t', header=1)
y1 = setNames(x[,7], x[,1])
...
pdf("OtherTE_DNA_RelocaTE2.summary.pdf", width=10, height=9)
...
#2
par(mar=c(4,0.5, 2, 1)) #set left and right to be tight with other plot
barplot(y3,horiz=TRUE,width=1,space=0, xlim=c(0, 60),  ylim=c(0.5,length(tree$tip.label)),names="", axes=FALSE)
axis(1, at= c(0, 20, 40, 60), line=0)
mtext("Gaijin", side=1,font=3, at=30,line=2.5, cex=1, col="black")
#3
par(mar=c(4,0.5, 2, 1)) #set left and right to be tight with other plot
...
mtext("spmlike", side=1,font=3, at=100,line=2.5, cex=1, col="black")
#4
par(mar=c(4,0.5, 2, 1)) #set left and right to be tight with other plot
...
#5
par(mar=c(4,0.5, 2, 1)) #set left and right to be tight with other plot
barplot(y6,horiz=TRUE,width=1,space=0, xlim=c(0, 30),  ylim=c(0.5,length(tree$tip.label)),names="", axes=FALSE)
axis(1, at= c(0, 10, 20, 30), line=0)
mtext("mGing", side=1,font=3, at=15,line=2.5, cex=1, col="black")
#6
par(mar=c(4,0.5, 2, 1)) #set left and right to be tight with other plot
