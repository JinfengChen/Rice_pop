...
def usage():
    print """
usage:
python make_BEDfile_all_protein_hits_500-window.py <TARGeT_protein_search_out_folder> <output_BEDfile> <genome_file> <output_flank_file> <output_hit_file>
...
subp.call(["bedtools", "merge", "-i", sorted_out_path, "-n", "500", "-s", "-nms", "-scores", "median"], stdout=union_out)
union_out.close()
