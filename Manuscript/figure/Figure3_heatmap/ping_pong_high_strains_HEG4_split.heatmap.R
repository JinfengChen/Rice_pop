pdf("ping_pong_high_strains_HEG4_split.heatmap.pdf")
library(reshape)
library(ggplot2)
library(Rmisc)
header <- c("NB", "EG4", "HEG4", "A119", "A123", "IRIS_313.15904", "B160", "B235", "OtherStrains")
ind <- read.table("ping_pong_high_strains_HEG4_split.matrix", row.names=1, header=TRUE)
ind_m <- as.matrix(ind)
